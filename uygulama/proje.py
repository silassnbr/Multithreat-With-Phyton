...
class MainWindow(QMainWindow,Ui_MainWindow):
    ...
    def __init__(self, *args, **kwgars):
        super().__init__(*args, **kwgars)
        self.setupUi(self)

        self.pushButton.pressed.connect(self.goster)
    def goster(self):
        a=a+1
...
# # print((df.loc[:,"Complaint ID"]))
# def senaryo():
#     print("S 1= sütun, benzerlik")
#     print("S 2= aynı olacak sütun, sütun, benzerlik")
#     print("S 3= eleman, sütun , benzerlik ")
#     print("S 4= thread, sütun , benzerlik")
#     s=int (input("senaryo seçiniz: "))
#     match s:
#         case 1:
#             senaryo1()
#         case 2:
...
#     #             print(value[same_product], value2[same_product])
...
#     bul=bul.index.values#ID si aranan değerin satırını getiri
#     input_column()
#     output_column()
#     similar()
#     input_thread()
...
#     input_thread()
#     threadSay()
#     # for limit in range(len(diziThread[0])):
#     #     hesapla(same_product="",s3_i=0,s3=0,limit=limit)
...
# def input_column():
#     global content#seçilecek sütun sayısı tutulur
#     content =[]
...
#     return content    
# def output_column():
#     global print_content#çıktıda gösterilecek sütun no
#     print_content=[]       
...
#         if(s3==1):
#             break 
#     #td=timedelta(microseconds=lasttime)
#     # lasttime=time.time()
#     # print(k,lasttime-starttime)
